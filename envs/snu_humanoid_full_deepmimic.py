...
class SNUHumanoidFullDeepMimicEnv(DFlexEnv):
    ...
    def calculateObservations(self):
        ...
        self.obs_buf = torch.cat([
            ...
            body_X_sc_local_ortho6d_translate.view(self.num_envs, -1), # 21:228
            self.joint_vel_obs_scaling * self.state.body_v_s.view(self.num_envs, -1), # 228:366
            phase.view(self.num_envs, 1), # 366:367
        ], dim=-1)
    ...
    body_X_sc_local_range = range(21, 228)
    joint_vel_range = range(228, 366)
    phase_range = range(366, 367)
